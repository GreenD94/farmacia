...
class UserUpdateRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        if(!$this->isUserImage()){$this->errorResponse(['id'=>['invalid id: id does not belong to user images']]);}
        return true;
    }
    ...
    public function rules()
    {
        return [
            ...
            'role_id'=>  [ new ExistsPair('tags','type','user_image','id')],
    ...
    {
        return Image::where('id',$this->id)->SearchByRelationship('Tag','type','user_image')->exists();
    }
}
