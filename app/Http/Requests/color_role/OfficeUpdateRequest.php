...
namespace App\Http\Requests\color_role;
...
class OfficeUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name'=>  [ new UniquePair('tags','type','branch_office_color')],
            'id'=>  ['required', new ExistsPair('tags','type','branch_office_color') ,'numeric','gte:1'],     
        ];
    }
