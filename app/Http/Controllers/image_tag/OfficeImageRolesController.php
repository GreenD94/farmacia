...
use App\Http\Requests\image_role\OfficeStoreRequest;
use App\Http\Requests\image_role\OfficeUpdateRequest;
use App\Models\Tag;
...
class OfficeImageRolesController extends Controller
{
    use Responser;
    ...
    public function FilterQuery($query,$request)
    {
        ...
        $query          ->where('type','branch_office_image');
